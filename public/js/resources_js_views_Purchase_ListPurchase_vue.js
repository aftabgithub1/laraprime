...
var render = function() {
  ...
  return _c(
    ...
    [
                ...
                _c("div", { staticClass: "p-fluid p-grid" }, [
                    ...
                    _c(
                      ...
                      [
                        _c("Dropdown", {
                          attrs: {
                            id: "suplier_filter",
                            options: _vm.suplier_filter,
                            optionLabel: "name"
                          },
                          model: {
                            value: _vm.suplierFilter,
                            callback: function($$v) {
                              _vm.suplierFilter = $$v
                            },
                            expression: "suplierFilter"
                          }
                        }),
                        _vm._v(" "),
                        _c("label", { attrs: { for: "suplier_filter" } }, [
                          _vm._v("Suplier")
                        ])
                      ],
                      1
                    ...
                    _c(
                      ...
                      [
                        _c("Dropdown", {
                          attrs: {
                            id: "warehouse_filter",
                            options: _vm.warehouse_filter,
                            optionLabel: "name"
                          },
                          model: {
                            value: _vm.warehouseFilter,
                            callback: function($$v) {
                              _vm.warehouseFilter = $$v
                            },
                            expression: "warehouseFilter"
                          }
                        }),
                        _vm._v(" "),
                        _c("label", { attrs: { for: "warehouse_filter" } }, [
                          _vm._v("Warehouse")
                        ])
                      ],
                      1
                  ...
                  _c("div", { staticClass: "p-field p-col-12 p-md-6" }, [
                    _c(
                      ...
                      [
                        _c("Calendar", {
                          attrs: { id: "from_date", showIcon: true },
                          model: {
                            value: _vm.from_date,
                            callback: function($$v) {
                              _vm.from_date = $$v
                  ...
                  _c("div", { staticClass: "p-field p-col-12 p-md-6" }, [
                    _c(
                      ...
                      [
                        _c("Calendar", {
                          attrs: { id: "to_date", showIcon: true },
                          model: {
                            value: _vm.to_date,
                            callback: function($$v) {
                              _vm.to_date = $$v
      ...
      _vm._v(" "),
      _c("div", { staticClass: "p-d-flex p-jc-between p-mb-2" }, [
